...
import com.muiezarif.quotesproject.databinding.ActivityHomeBinding
import com.muiezarif.quotesproject.fragments.AuthorsFragment
import com.muiezarif.quotesproject.fragments.CategoryFragment
import com.muiezarif.quotesproject.fragments.QuotesFragment
...
class HomeActivity : AppCompatActivity(), BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    private var mSensorService: NotificationService? = null
...
//        init()
    ...
    private fun init(){
        ...
        binding.homeHeader.tvRewwardAdCount.text=adWatchCount.toString()
//        mSensorService = NotificationService(context)
//        mServiceIntent = Intent(context, NotificationService::class.java)
...
//    }
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        when(item.itemId){
            ...
            R.id.category_menu->{
                var fragmentTransaction =supportFragmentManager.beginTransaction()
                fragmentTransaction.replace(binding.flhome.id, CategoryFragment()).commit()
            }
            R.id.author_menu->{
                var fragmentTransaction =supportFragmentManager.beginTransaction()
